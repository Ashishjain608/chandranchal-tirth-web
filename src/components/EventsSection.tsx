  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* ---- Empty State ---- */}
        {EVENTS_SECTION.events.length === 0 && (
          <div className="text-center py-16">
            <p className="text-lg text-text-light leading-relaxed">
              {EVENTS_SECTION.emptyMessage}
            </p>
          </div>
        )}
                ...
                >
                  ...
                  <div className="relative h-48 w-full overflow-hidden bg-tertiary sm:h-56 md:h-60">
                    ...
                    <div className="absolute top-4 right-4">
                      <span
                        className={`inline-block rounded-full border px-3 py-1 text-xs font-medium ${statusInfo.className}`}
                      >
                        {statusInfo.label}
                      </span>
                    </div>
